...
🗓️ October 28, 2024 \| 13:00-16:00 EDT
...
tibble::tribble(
  ~time, ~desc,
  "Section 1", "[Introduction to the Analysis Results Standard and {cards}](https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/slides/01-intro-cards)",
  "Section 2", "[Introduction to the {cardx} Package and ARD Extras](https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/slides/02-intro-cardx)",
  "Section 3", "[ARD to Tables with {gtsummary}](https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/slides/03-tables-gtsummary)",
  "Section 4", "[ARD to Tables with {tfrmt}](https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/slides/04-tables-tfrmt)",
) |> 
  gt::gt() |> 
