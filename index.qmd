...
tibble::tribble(
  ~time, ~desc,
  "Section 1", "Introduction to the Analysis Results Standard and {cards}",
  "Section 2", "Introduction to the {cardx} Package and ARD Extras",
  "Section 3", "ARD to Tables with {gtsummary}",
  "Section 4", "ARD to Tables with {tfrmt}",
) |> 
  gt::gt() |> 
