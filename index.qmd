...
tibble::tribble(
  ~time, ~desc,
  "Section 1a", "Introduction to the Analysis Results Standard",
  "Section 1b", "The {cards} Package",
  "Section 2", "The {cardx} Package",
  "Section 3", "ARD Extras",
  "Section 4", "ARD to Tables with {gtsummary} and {tfrmt}",
) |> 
  gt::gt() |> 
